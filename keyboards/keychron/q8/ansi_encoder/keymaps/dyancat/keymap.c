...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [MAC_BASE] = LAYOUT_ansi_69(
        ...
        KC_CESC, KC_A,     KC_S,     KC_D,    KC_F,    KC_G,              KC_H,    KC_J,    KC_K,    KC_L,     KC_SCLN,  KC_QUOT,  KC_ENT,           KC_F19,
    ...
    [WIN_BASE] = LAYOUT_ansi_69(
        ...
        KC_TAB,  KC_QUOT,  KC_COMM,  KC_DOT,  KC_P,    KC_Y,    KC_F,     KC_G,    KC_C,    KC_R,    KC_L,     KC_SLSH,  KC_EQL,   KC_BSLS,          KC_F18,
        KC_CESC, KC_A,     KC_O,     KC_E,    KC_U,    KC_I,              KC_D,    KC_H,    KC_T,    KC_N,     KC_S,     KC_MINS,  KC_ENT,           KC_F19,
        KC_LSFT,           KC_SCLN,  KC_Q,    KC_J,    KC_K,    KC_X,     KC_X,    KC_B,    KC_M,    KC_W,     KC_V,     KC_Z,     KC_RSFT, KC_UP,
        KC_LCTL, KC_LGUI,  KC_LALT,           KC_SFN1,          MO(_FN1), MO(_FN1),         KC_SPC,            MO(_FN2),           KC_LEFT, KC_DOWN, KC_RGHT),
    ...
    [_FN2] = LAYOUT_ansi_69(
        ...
        _______, _______,  _______,  _______, _______, _______, _______,  _______, _______, _______, KC_HOME,  KC_UP,    KC_END,   _______,          _______,
...
const uint16_t PROGMEM encoder_map[][NUM_ENCODERS][NUM_DIRECTIONS] = {
    ...
    [_FN2]   = {ENCODER_CCW_CW(KC_DOWN, KC_UP)},
